    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <div className="space-x-4">
          <Link href="/apply" className="bg-primary-600 hover:bg-primary-700 text-white font-bold py-3 px-8 rounded-lg text-lg inline-block">
            Apply for a Loan
          </Link>
          <Link href="/signup" className="border border-primary-600 text-primary-600 hover:bg-primary-50 font-bold py-3 px-8 rounded-lg text-lg inline-block">
            Become an Investor
          </Link>
        </div>
      </div>
      ...
      <div className="bg-primary-600 rounded-lg p-8 text-center text-white">
        ...
        <Link href="/apply" className="bg-white text-primary-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg text-lg inline-block">
